...
function SettingsForm({
  ...
  const save = useMutation({
    mutationFn: (section: Exclude<Section, "SOURCES">) =>
  ...
  const handleSave = (section: Exclude<Section, "SOURCES">) => {
    setAttempted(true);
    if (section === "PROFILE") {
  ...
  const errorNotice = (section: "PROFILE" | "SPLIT") => {
    ...
    if (section === "SPLIT") return null;
    return <Notice tone="bad" title="Check the highlighted fields" />;
  };
  ...
  const sectionHint = (section: Section) =>
    `Opens ${sectionTitles[section].toLowerCase()} in a sheet`;
  ...
  return (
    ...
    >
      ...
      <FormSheet
        visible={openSection === "PROFILE"}
        onClose={() => onToggleSection("PROFILE")}
        eyebrow="Settings"
      ...
      <FormSheet
        visible={openSection === "SPLIT"}
        onClose={() => onToggleSection("SPLIT")}
        eyebrow="Settings"
      ...
      >
        ...
        <Button
          ...
          tone="accent"
          loading={save.isPending}
          onPress={() => handleSave("SPLIT")}
        />
      </FormSheet>

      <FormSheet
        visible={openSection === "SOURCES"}
        onClose={() => onToggleSection("SOURCES")}
        eyebrow="Settings"
...
function SourceRow({
  ...
  const platform = source.prototype
    ? "Simulated platform"
    : "Connected platform";
